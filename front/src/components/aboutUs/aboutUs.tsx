...
export const AboutUs = ( { isOpen, closeClick }: AboutUsProps ): React.ReactElement => {
    ...
    return (
        <div className={`sm:left-0 sm:text-[13px] sm:right-0 sm:w-full bottom-10 flex-col w-[563px] lg:left-[100px] p-[24px] sm:p-[10px] rounded-[16px] gap-[16px] absolute bg-white`}>
